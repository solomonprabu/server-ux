...
class Base(models.AbstractModel):
    ...
    def get_views(self, views, options=None):
        ...
        can_archive = self.env["ir.model.access"].check(self._name, "archive", raise_exception=False)
        can_unarchive = self.env["ir.model.access"].check(self._name, "unarchive", raise_exception=False)
